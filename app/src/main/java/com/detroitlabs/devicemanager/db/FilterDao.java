...
public class FilterDao {
    ...
    private void updateFilterQuery(String query, Object[] args) {
        ...
        try {
            ...
            final int _cursorIndexOfIsRegistrable = cursor.getColumnIndexOrThrow("isRegistrable");
            ...
            while (cursor.moveToNext()) {
                ...
                final int _tmp_1 = cursor.getInt(_cursorIndexOfIsRegistrable);
                device.isRegistrable = _tmp_1 != 0;
                _result.add(device);
            }
